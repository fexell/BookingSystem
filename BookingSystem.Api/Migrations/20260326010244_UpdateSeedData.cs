        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "role-admin-stamp-002", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Bookings",
                columns: new[] { "Id", "CreatedAt", "EndTime", "FirstName", "Notes", "PartySize", "ResourceId", "StartTime", "Status", "Surname", "UserId" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 20, 10, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 3, 27, 12, 0, 0, 0, DateTimeKind.Unspecified), "Anna", "Need drumset", 2, 1, new DateTime(2026, 3, 27, 10, 0, 0, 0, DateTimeKind.Unspecified), "Active", "Svensson", 2 },
                    { 2, new DateTime(2026, 3, 20, 11, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 3, 27, 15, 0, 0, 0, DateTimeKind.Unspecified), "Erik", "Acoustic session", 1, 2, new DateTime(2026, 3, 27, 13, 0, 0, 0, DateTimeKind.Unspecified), "Active", "Johansson", 3 }
                });
        }
