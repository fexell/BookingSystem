...
public class AppDbContext : IdentityDbContext<User, IdentityRole<int>, int> {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IdentityRole<int>>().HasData(
            new IdentityRole<int> { Id = 1, Name = "Admin", NormalizedName = "ADMIN", ConcurrencyStamp = "role-admin-stamp-001" },
            new IdentityRole<int> { Id = 2, Name = "User", NormalizedName = "USER", ConcurrencyStamp = "role-user-stamp-002" }
        );
        ...
        modelBuilder.Entity<Booking>().HasData(
            ...
            new Booking
            {
                ...
                CreatedAt = new DateTime(2026, 3, 26, 11, 0, 0)
            }
        );
    }
}